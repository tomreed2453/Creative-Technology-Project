...
$password = "nCXx2555";
$dbname = "fet12010351";
if(isset($_GET['idcassette'])){
	$idcd = $_GET['idcassette'];
}else{
	$idcassette = '';
}
// Create connection
...
$sql = "SELECT idcassette, artist, title, year, genre, cover, recordlabel FROM cassette WHERE idcassette != '$idcassette' ORDER BY RAND() LIMIT 1";
...
echo '<form action="randomcassette.php?idcassette='. $idcassette.'" method="post">
