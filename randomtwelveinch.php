...
$sql = "SELECT idtwelveinch, artist, title, year, genre, cover, recordlabel FROM twelveinch WHERE idtwelveinch != '$idtwelveinch' ORDER BY RAND() LIMIT 1";
...
echo '<form action="randomtwelveinch.php?idtwelveinch='. $idtwelveinch.'" method="post">
