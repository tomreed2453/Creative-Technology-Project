...
$sql = "SELECT idcd, artist, title, year, genre, cover, recordlabel FROM cd WHERE idcd != '$idcd' ORDER BY RAND() LIMIT 1";
...
echo '<form action="randomcd.php?idcd='. $idcd.'" method="post">
