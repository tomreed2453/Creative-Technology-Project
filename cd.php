...
<body>
    ...
    <p> <a href="randomcd.php">RANDOM</a></p>
    </div>
          <p class="pagenames"> CD </p>


          <div class="cdmain">
           <img class="iconimg" src="img/mycd.png">
             
             <p><a href="addalbumcd.html"> ADD TO</a></p> 
    </div>  
<div class="echo">	
<?php
$servername = "mysql5";
...
$sql = "SELECT artist, title, year, genre, cover, recordlabel FROM cd ORDER BY artist ASC";
