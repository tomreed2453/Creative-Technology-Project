...
$sql = "SELECT idseveninch, artist, title, year, genre, cover, recordlabel FROM seveninch WHERE idseveninch != '$idseveninch' ORDER BY RAND() LIMIT 1";
...
echo '<form action="randomseveninch.php?idseveninch='. $idseveninch.'" method="post">
